...
pub fn disInstruction(self: *Self, writer: *Writer, offset: usize) usize {
    ...
    return switch (op) {
        ...
        .array_get_cow => self.simpleInstruction(writer, "array_get_cow", offset),
        ...
        .str_mul_l => self.simpleInstruction(writer, "str_mul_l", offset),
        .str_mul_r => self.simpleInstruction(writer, "str_mul_r", offset),
