...
pub fn disInstruction(self: *const Self, offset: usize, writer: anytype) (Allocator.Error || std.posix.WriteError)!usize {
    ...
    return switch (op) {
        ...
        // .array_assign_chain_reg => self.indexInstruction("OP_ARRAY_ASSIGN_CHAIN_REG", offset, writer),
        ...
        // .array_assign_reg => self.simpleInstruction("OP_ARRAY_ASSIGN_REG", offset, writer),
        ...
        .get_local_cow => self.indexInstruction("OP_GET_LOCAL_COW", offset, writer),
