...
pub fn disInstruction(self: *Self, offset: usize, writer: anytype) (Allocator.Error || std.posix.WriteError)!usize {
    ...
    return switch (op) {
        ...
        .get_capt_frame => self.indexInstruction("get_capt_frame", offset, writer),
        .get_capt_local => self.indexInstruction("get_capt_local", offset, writer),
        ...
        .neg_float => self.simpleInstruction("neg_float", offset, writer),
        .neg_int => self.simpleInstruction("neg_int", offset, writer),
