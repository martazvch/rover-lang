...
pub const ParserMsg = union(enum) {
    ...
    pub fn getMsg(self: Self, writer: *Writer) !void {
        try switch (self) {
            ...
            .expect_brace_after_when_body => writer.writeAll("expect closing brace after 'when' body"),
    ...
    pub fn getHelp(self: Self, writer: *Writer) !void {
        try switch (self) {
            ...
            .expect_brace_after_struct_body, .expect_brace_after_when_body => writer.writeAll("add an closing brace '}'"),
