...
pub const ParserMsg = union(enum) {
    ...
    pub fn getMsg(self: Self, writer: *Writer) !void {
        try switch (self) {
            ...
            .expect_brace_after_enum_body => writer.writeAll("expect opening brace after enum's body"),
    ...
    pub fn getHelp(self: Self, writer: *Writer) !void {
        try switch (self) {
            ...
            .expect_brace_after_enum_body => writer.writeAll("add an closing brace '}'"),
