...
fn identifier(
    ...
    if (self.symbolIdentifier(name, ctx)) |sym| {
...
fn symbolIdentifier(self: *Self, name: InternerIdx, ctx: *const Context) error{BigSelfOutsideStruct}!?*ScopeStack.Scope.Symbol {
