pub const ParserMsg = union(enum) {
    ...
    pub fn getMsg(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .missing_equal_named_param => writer.writeAll("expect equal sign '=' after parameter's name"),
    ...
    pub fn getHint(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .expect_expr, .expect_new_line => writer.print("here", .{}),
    ...
    pub fn getHelp(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .missing_brace_items_import => writer.writeAll("syntax to import specific items from module is: use foo{ item1, ... }"),
            .missing_comma_after_field => writer.writeAll("structure fields have ot be separated by commas"),
            .missing_equal_named_param => writer.writeAll("syntaxe for named parameters is: '<name>=<value>"),
