pub const ParserMsg = union(enum) {
    ...
    pub fn get_msg(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .ExpectBraceOrDoAfterIf => writer.print("expect opening brace or 'do' after 'if' condition", .{}),
    ...
    pub fn get_hint(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .ExpectBraceOrDoAfterIf => writer.print("expect to be here", .{}),
    ...
    pub fn get_help(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .ExpectBraceOrDoAfterIf => writer.print("add an opening brace '{{' or 'do' keyword before statement", .{}),
