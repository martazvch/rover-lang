...
pub const ParserMsg = union(enum) {
    ...
    pub fn getHelp(self: Self, writer: *Writer) !void {
        try switch (self) {
            ...
            .expect_brace_before_fn_body, .expect_brace_before_struct_body => writer.writeAll("add an opening brace '{'"),
            ...
            .expect_brace_or_do => writer.writeAll("add an opening brace '{' or 'do' keyword before statement"),
