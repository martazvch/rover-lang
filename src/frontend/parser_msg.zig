pub const ParserMsg = union(enum) {
    ...
    pub fn get_msg(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .exepct_type_or_value_in_decl => writer.writeAll("expect either a value or a type in varibale declaration"),
    ...
    pub fn get_hint(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .exepct_type_or_value_in_decl => writer.writeAll("this variable has no type and no value"),
    ...
    pub fn get_help(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .exepct_type_or_value_in_decl => writer.writeAll("provide either a default value so that the compiler can infer the type or a type"),
