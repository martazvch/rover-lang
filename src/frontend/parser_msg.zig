pub const ParserMsg = union(enum) {
    ...
    pub fn get_msg(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .ExpectBraceAfterStructInit => writer.print("expect opening brace after structure's name in structure initialization", .{}),
    ...
    pub fn get_help(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .ExpectBraceAfterStructInit => writer.writeAll("add an openning brace '{{'"),
