...
pub const AnalyzerMsg = union(enum) {
    ...
    pub fn get_msg(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .IncompatibleFnType => |e| writer.print("function declared as returning '{s}' type but found '{s}'", .{ e.expect, e.found }),
            .IncompatibleIfType => |e| writer.print("'if' and 'else' have incompatible types, found '{s}'  and '{s}'", .{ e.found1, e.found2 }),
            ...
            .TypeMismatch => |e| writer.print("type mismatch, expect a '{s}' but found '{s}' ", .{ e.expect, e.found }),
            ...
            .WrongFnArgsCount => |e| writer.print("expect {s} function arguments but found {s}", .{ e.expect, e.found }),
        };
    }
    ...
    pub fn get_hint(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .undeclared_field_access, .UndeclaredType, .UndeclaredVar, .UseUninitVar => writer.writeAll("here"),
    ...
    pub fn get_help(self: Self, writer: anytype) !void {
        try switch (self) {
            ...
            .InvalidAssignType => |e| writer.print("variable is declared of type '{s}' but expression is of type '{s}'", .{ e.expect, e.found }),
            ...
            .SelfOutsideStruct => writer.writeAll("'self' is a reserved keyword. Use another parameter name"),
            ...
            .TooManyTypes => writer.writeAll("it's a compiler limitation but the code shouldn't anyway have that much types. Try rethink you code"),
            ...
            .UnpureInGlobal => writer.writeAll("use a constant expression or initialize the value later in a local scope"),
